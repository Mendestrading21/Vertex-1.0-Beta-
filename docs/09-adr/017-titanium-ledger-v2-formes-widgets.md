...
- **Dégradés.** Un dégradé est soit une variation de matériau déjà admise (dominante : `titanium-soft` → transparent), soit l'aire sous une série servie. Jamais un fond plein de carte, jamais entre deux teintes, jamais décoratif.
